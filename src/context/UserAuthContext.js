...
export function UserAuthContextProvider({ children }) { // Fixed 'childern' to 'children'
    ...
    return <userAuthContext.Provider value={{user, signUp, logIn,logOut,googleSignIn ,facebookSignIn}}>{children}</userAuthContext.Provider> // Fixed 'childern' to 'children'
